...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/Dekstra/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Dekstra/dekstra-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Dekstra/dekstra/releases"
fi
