...
if ! declare -F load_linux_png &>/dev/null; then
  load_linux_png() {
    wget "https://raw.githubusercontent.com/Dekstra/icons/main/icons/linux/circle1/${COLOR}/paulo22s.png" -O "$1"
  }
fi

if ! declare -F load_windows_ico &>/dev/null; then
  load_windows_ico() {
    wget "https://raw.githubusercontent.com/Dekstra/icons/main/icons/win32/nobg/${COLOR}/paulo22s.ico" -O "$1"
  }
fi
