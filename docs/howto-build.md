...
Here is the base script to build Dekstra:
...
- Linux: https://github.com/Dekstra/dekstra/blob/master/.github/workflows/stable-linux.yml
- macOS: https://github.com/Dekstra/dekstra/blob/master/.github/workflows/stable-macos.yml
- Windows: https://github.com/Dekstra/dekstra/blob/master/.github/workflows/stable-windows.yml
...
- open `vscode` directory in a new **Dekstra**'s window
- fix all the `*.rej` files
- run `npm run watch`
- run `./script/code.sh` until everything is ok
