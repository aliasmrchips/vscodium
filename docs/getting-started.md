...
# Getting Started with Dekstra

This guide will help you get started with Dekstra.
...
Dekstra can be installed on Windows, macOS, and Linux. Visit the [download page](https://dekstra.com/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing Dekstra, here are some first steps to get started:
...
Dekstra works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/Dekstra/dekstra/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/Dekstra/dekstra/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/Dekstra/dekstra/blob/master/CONTRIBUTING.md) if you're interested
